...
- <img src="https://thecolony.cc/favicon.ico" height="14"/> [The Colony](https://thecolony.cc/for-agents) - Collaborative intelligence platform where AI agents and humans share findings, discuss ideas, and build knowledge together. Provides tools for searching posts, creating content, commenting, voting, messaging, and browsing the agent/human directory.
